# Factory Data Consistency Audit — 2026-09-01
...
| blog/gan-v-charger-oem-manufacturing/index.njk | EN | Defect rate <0.3% | 1.0 | 0.0-0.3 | high |
...
| fr/blog/chargeur-voiture-oem-guide/index.njk | FR | ODM-b production (custom packaging) 35-45 days | (3.0, 7.0) | 35-45 | medium |
...
| ru/blog/gan-zaryadnye-ustroystva-oem-rukovodstvo/index.njk | RU | OEM mass production 30-60 days | (25.0, 35.0) | 30-60 | high |
...
| ru/blog/gan-zaryadnye-ustroystva-oem-rukovodstvo/index.njk | RU | MOQ ODM 500 (in-stock) / 1,000-2,000 (new design) | 3000.0 | 500-2000 | medium |
...
- **es/blog/verificacion-fabricas-checklist/index.njk** [ES] `AQL 0.65 (normal) / 0.25 (tightened)`: “…toría del proceso QC",           "text": "IQC con AQL 1.0 en críticos, IPQC cada 100 unidades, FQC al 100%,…”
...
- **ru/blog/gan-zaryadnye-ustroystva-oem-rukovodstvo/index.njk** [RU] `AQL 0.65 (normal) / 0.25 (tightened)`: “… \u043f\u0440\u0438\u0451\u043c\u043a\u043e\u0439 AQL 2.5","itemListElement":[{"@type":"HowToDirection","te…”
- **ru/blog/ispytanie-prokolom-gvozdem-polutverdotelnye-oem/index.njk** [RU] `AQL 0.65 (normal) / 0.25 (tightened)`: “…b\u043e\u043c \u0432 \u0437\u043e\u043d\u0435 QC (AQL 2.5 Level II) \u0438 \u043c\u043e\u0436\u0435\u0442 \…”
...
- **ru/blog/sertifikaciya-eas-poverbankov-tr-ts-oem/index.njk** [RU] `AQL 0.65 (normal) / 0.25 (tightened)`: “… class="text-slate-600 text-xs">4-ступенчатый QC, AQL 2.5, старение 100% 4 часа, дефектность ниже 0,3%.</p>…”
...
- **blog/gan-v-charger-oem-manufacturing/index.njk** [EN] `Defect rate <0.3%`: “… at full load for 4+ hours, no chip traceability, defect rate above 1%."           }         },         {           "@ty…”
...
- **ru/blog/technologiya-gan-zaryadnye-ustroystva-oem/index.njk** [RU] `Defect rate <0.3%`: “…арантии:</strong> пеня за просрочку более 7 дней, уровень дефектов ниже 0,5%, поддержка отзыва, бесплатные обновления сертифик…”
...
- **fr/blog/chargeur-voiture-oem-guide/index.njk** [FR] `ODM-b production (custom packaging) 35-45 days`: “…r de 500 pièces. Certification CE/E-Mark incluse, emballage personnalise et livraison DDP en France. Échantillons en 3-7 jours, délai de production 25-30 jours. Prix FOB:…”
...
- **ru/blog/gan-zaryadnye-ustroystva-oem-rukovodstvo/index.njk** [RU] `OEM mass production 30-60 days`: “…кс) или новая разработка ODM. При MOQ 3,000+ шт.: OEM с новой оснасткой. Срок производства: 25-35 дней (ODM в наличии), 35-50 дней (новая разработка).</…”
...
- **ru/blog/gan-zaryadnye-ustroystva-oem-rukovodstvo/index.njk** [RU] `MOQ ODM 500 (in-stock) / 1,000-2,000 (new design)`: “…аковка (брендированный бокс) или новая разработка ODM. При MOQ 3,000+ шт.: OEM с новой оснасткой. Срок производства: 2…”
...
- **fr/blog/fournisseurs-chargeurs-chine-oem/index.njk** [FR] `Production yield >98%`: “…ge. Le Règlement Ecoconception 2025/2052 exige un rendement minimum même a 10% de charge. La Déclaration de Conformité doit être…”
...
- **fr/blog/usb-c-pd-3-1-guide-oem/index.njk** [FR] `Production yield >98%`: “…i>     <li><strong>Ecodesign 2025/2052</strong> — rendement actif ≥87 %, veille ≤0,5 W (impose de fait le GaN au-dessus d…”
...
- **de/blog/lieferanten-china-finden/index.njk** [DE] `durchschnitt` → [('', '30 %', '')]: “…Ungew\u00f6hnlich niedrige Preise \u2014 20-30 % unter Marktdurchschnitt deutet auf minderwertige Komponenten. (4) Kommunikation nur \u00fcber WhatsApp/WeChat ohne offizielle Firmen-E-Mail. (5) Ablehnung eines Video-Werksrundgangs…”
...
- **de/blog/powerbank-spezifikationen/index.njk** [DE] `durchschnitt` → [('', '20%', '')]: “…Design. Modelle mit integrierten Kabeln erzielen auf Amazon durchschnittlich 15-20% h\u00f6here Bewertungen. Nachteil: Bei Kabeldefekt muss die gesamte Powerbank ersetzt werden. F\u00fcr B2B-Kunden und Werbeartikel sind Built-in-C…”
...
- **es/blog/como-elegir-power-bank/index.njk** [ES] `la mayoría de competidores` → [('$11.000-14.000 ', '', '')]: “…or + embalaje + certificaciones), WOWOHCOOL ofrece MOQ 500, la mayoría de competidores exigen 1.000+. ODM: 2.000 uds (desarrollo de diseño exclusivo). Coste total estimado del primer pedido de 500 uds de 10.000mAh DDP España: ~$11…”
...
- **fr/blog/controle-qualite-usines-chinoises-oem/index.njk** [FR] `moyenne du secteur` → [('', '0,3 %', ''), ('', '5 %', '')]: “…). Résultat: taux de retour terrain <0,3 % vs 2-5 % pour la moyenne du secteur."           }         },         {           "@type": "Question",           "name": "Combien coûte un contrôle qualité complet en Chine?",           "a…”
...
- **fr/blog/controle-qualite-usines-chinoises-oem/index.njk** [FR] `moyenne du secteur` → [('', '0,3 %', ''), ('', '5 %', '')]: “… de retour terrain <strong><0,3 % vs 2-5 %</strong> pour la moyenne du secteur.</p></div>  <div class="bg-white rounded-xl p-6 faq-answer"><h3 class="font-black text-brandBlue mb-2">Combien coûte un contrôle qualité complet en Chi…”
...
- **ru/blog/specifikacii-power-bank-oem/index.njk** [RU] `Бюджетные фабрики` → [('$1 500-3 000', '', ''), ('', '25%', ''), ('', '8%', '')]: “…. Не включает: EAC-декларирование ($1 500-3 000), доставку. Бюджетные фабрики предлагают цены на 15-25% ниже, но на ячейках Grade B с возвратами 5-8%."           }         },         {           "@type": "Question",           "nam…”
- **ru/blog/specifikacii-power-bank-oem/index.njk** [RU] `Бюджетные фабрики` → [('$1 500-3 000', '', ''), ('', '25%', ''), ('', '8%', '')]: “…-ступенчатый QC. Не включено: EAC ($1 500-3 000), доставка. Бюджетные фабрики с ячейками Grade B: на 15-25% дешевле, но с возвратами 5-8%.</p>     </div>     <div class="bg-white rounded-xl p-6 faq-answer">      <h3 class="font-bl…”
