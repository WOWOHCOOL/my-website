"""
Deep metadata audit for ES blog — adapted from EN audit.

Language-specific expectations:
  - inLanguage: es-ES
  - Organization.url / publishingPrinciples: /es/about/ (or root)
  - CanonicalUrl prefix: https://www.wowohcool.com/es/blog/
"""
import re
import json
import os
...
BLOG = Path(r"C:\Users\wowoh\wowohcool.com\src\es\blog")
LANG_CODE = "es-ES"
EXPECTED_ORG_URLS = (
    "https://www.wowohcool.com/es/about/",
...
def audit_one(slug):
    ...
    if person and isinstance(person.get("url"), str):
        u = person["url"]
        if u in ("https://www.wowohcool.com/about/", "https://www.wowohcool.com/es/about/") or u.endswith("/about"):
