"""
Deep metadata audit for DE blog — adapted from EN audit.

Language-specific expectations:
  - inLanguage: de-DE
  - Organization.url / publishingPrinciples: /de/about/ (or root)
  - CanonicalUrl prefix: https://www.wowohcool.com/de/blog/
"""
import re
import json
import os
...
BLOG = Path(r"C:\Users\wowoh\wowohcool.com\src\de\blog")
LANG_CODE = "de-DE"
EXPECTED_ORG_URLS = (
    "https://www.wowohcool.com/de/about/",
...
def audit_one(slug):
    ...
    if person and isinstance(person.get("url"), str):
        u = person["url"]
        if u in ("https://www.wowohcool.com/about/", "https://www.wowohcool.com/de/about/") or u.endswith("/about"):
